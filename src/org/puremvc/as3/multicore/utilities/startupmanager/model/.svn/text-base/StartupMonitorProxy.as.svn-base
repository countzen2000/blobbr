...
package org.puremvc.as3.multicore.utilities.startupmanager.model
{
	...
	*  jobId property could be useful.  There is also a cleanup operation, useful to the client application
	*  when it is finished with the monitor.</p>
	*  <p>
	...
	*/
    public class StartupMonitorProxy extends Proxy implements IProxy {
        ...
        /**
        *  This var is used by the addResourceViaStartupProxy method.  The client app can assign a value,
        *  to override the initial value, if desired.
        */
        public var prefixIfAutoSRPName :String = StartupManager.PREFIX_IF_AUTO_SRP_NAME;
		...
		public function addResourceViaStartupProxy( px :IStartupProxy, resourceProxyName :String = null ) :void {
		    var srpName :String = ( resourceProxyName ? resourceProxyName : prefixIfAutoSRPName + px.getProxyName() );
		    var srp :StartupResourceProxy = new StartupResourceProxy( srpName, px );
		    facade.registerProxy( srp );
		    addResource( srp );
		}
		/**
         *  Add resourceS via an array of StartupProxy objects - alternative to adding them singly.  In this
         *  case, the client app must accept the default naming of the StartupResourceProxy objects. 
         */
         ...
         *  operation, that is, removal of the previous StartupResourceProxy objects from the map of 
         *  registered proxies.
         *  <p>
         *  It is recommended that the client app check via isOkToReset() before invoking reset().
         *  See also the jobId property.
         *  Throws Error if reset is not allowed.</p>
         */
        ...
        /**
         *  This cleanup feature deals with removal of object state that is closely bound with this startup 
         ...
         *  <ul>
         *  <li>removal of the StartupResourceProxy objects from the map of registered proxies.</li>
         *  </ul></p>
         */
